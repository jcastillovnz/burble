...
<!-- MODAL NUEVO CLIENTE -->
<div    class="modal fade clienteEdit" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
<div class="modal-dialog modal-sm-8">
 <div  id="AppClientes" class="modal-content">
<form  v-on:submit.prevent="update(this)"    method="GET" class="hidden" role="form"     >
...
<input required="" type="text" class="form-control" :disabled="state == 0"   v-model="cliente.nombre" placeholder="Nombre de empresa">
</div>
...
<input   :disabled="state == 0" class="form-control" v-model="cliente.telefono" placeholder="Telefono">
</div>
